...
║{Fore.CYAN}  ╚═════╝  ╚═════╝ ╚══════╝╚══════╝ ╚═════╝ ╚═╝  ╚═╝╚═════╝ ╚══════╝{Fore.YELLOW}║
╠══════════════════════════════════════════════════════════════════╣
║{Fore.RED}  HELL SOCIETY - Privilege Escalation Detector v2.0                 {Fore.YELLOW}║
╚══════════════════════════════════════════════════════════════════╝
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Hell Society Privilege Escalation Detector')
    args = parser.parse_args()

    detector = PrivEscDetector()
    detector.detect()
