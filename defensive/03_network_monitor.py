...
║{Fore.RED}    ╚═══╝  ╚══════╝╚═╝  ╚═╝╚══════╝╚═╝     ╚══════╝╚═╝  ╚═╝ ╚═════╝ {Fore.CYAN}║
╠══════════════════════════════════════════════════════════════════╣
║{Fore.YELLOW}  HELL SOCIETY - Network Traffic Monitor v2.0                           {Fore.CYAN}║
╚══════════════════════════════════════════════════════════════════╝
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Hell Society Network Monitor')
    parser.add_argument('-i', '--interface', default='any', help='Network interface')
    parser.add_argument('-d', '--duration', type=int, default=60, help='Monitor duration (seconds)')
    args = parser.parse_args()

    monitor = NetworkMonitor(args.interface, args.duration)
    monitor.monitor()
