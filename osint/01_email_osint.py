...
║{Fore.CYAN}  ╚══════╝   ╚═╝   ╚══════╝   ╚═╝    ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝      {Fore.MAGENTA}║
╠══════════════════════════════════════════════════════════════════╣
║{Fore.YELLOW}  HELL SOCIETY - Email OSINT Recon v2.0                           {Fore.MAGENTA}║
╚══════════════════════════════════════════════════════════════════╝
"""
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Hell Society Email OSINT')
    parser.add_argument('-e', '--email', required=True, help='Target email')
    args = parser.parse_args()

    recon = EmailOSINT(args.email)
    recon.run()
