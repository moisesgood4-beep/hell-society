#!/usr/bin/env python3
"""GitHub OSINT - Extract information from GitHub profiles."""
import os, sys, json
try:
...
def get_repos(username):
    try:
        r = requests.get(f"https://api.github.com/users/{username}/repos?sort=updated&per_page=10", timeout=10)
        return r.json() if r.status_code == 200 else []
    except: return []

def search_code(username):
    try:
        r = requests.get(f"https://api.github.com/search/code?q={username}&per_page=5", timeout=10)
...
def main():
    ...
    print(BANNER)
    print()
    print(f"  {BW}{Style.BRIGHT}  GITHUB OSINT{RS}")
    print(f"  {Y}{Style.BRIGHT}  HELL SOCIETY Community{RS}")
    print()
    while True:
        print(f"  {G}╔╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╗{RS}")
        print(f"  {G}╟  {BW}GITHUB OSINT                            {RS}  {G}╟{RS}")
        print(f"  {G}╚╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╝{RS}")
        print()
        ...
        print()
        if choice == '1':
            print(f"  {G}[*] Starting Github Osint...{RS}")
