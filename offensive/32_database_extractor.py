...
def main():
    ...
    print(BANNER)
    print()
    print(f"  {BW}{Style.BRIGHT}  DATABASE EXTRACTOR{RS}")
    print(f"  {Y}{Style.BRIGHT}  HELL SOCIETY Community{RS}")
    print()
    while True:
        print(f"  {G}╔╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╗{RS}")
        print(f"  {G}╟  {BW}DATABASE EXTRACTOR                      {RS}  {G}╟{RS}")
        print(f"  {G}╚╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╜╝{RS}")
        print()
        print(f"  {C}[1]  {BW}Target URL                                   {RS}")
        print(f"  {C}[2]  {BW}Parameter to inject (e.g., id, user)         {RS}")
        print()
        ...
        if choice == '1':
            ...
            print()
        if choice == '2':
            print(f"  {Y}[*] Parameter to inject (e.g., id, user){RS}")
