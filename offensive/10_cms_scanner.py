...
║{Fore.RED}   ╚═════╝   ╚═╝   ╚═════╝ ╚══════╝╚═════╝ ╚═╝ ╚═════╝ ╚══════╝     {Fore.YELLOW}║
╠══════════════════════════════════════════════════════════════════╣
║{Fore.CYAN}  HELL SOCIETY - CMS Vulnerability Scanner v2.0                       {Fore.YELLOW}║
╚══════════════════════════════════════════════════════════════════╝
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Hell Society CMS Scanner')
    parser.add_argument('-u', '--url', required=True, help='Target URL')
    args = parser.parse_args()

    scanner = CMSScanner(args.url)
    print(f"{Fore.CYAN}  [*] Target: {Fore.WHITE}{args.url}")
    print(f"{Fore.CYAN}  [*] Starting CMS scan...\n")
